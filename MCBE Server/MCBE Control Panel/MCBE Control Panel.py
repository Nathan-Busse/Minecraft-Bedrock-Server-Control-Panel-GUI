...
A control dashboard to monitor and control your minecraft bedrock dedicated server through an easy user interface.
...
class GUI(tkinter.Tk):
    default_server_dir =os.path.expanduser('~/Documents/MCBE Server') 
