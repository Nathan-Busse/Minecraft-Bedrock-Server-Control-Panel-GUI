...
# Splash screen
    ...
    img=PhotoImage(file='~/Documents/Creation Valley Server/MCBE Control Panel/Dependencies/MCBE.png')
    ...
    class GUI(tkinter.Tk):
        ...
        default_server_dir =os.path.expanduser('~/Documents/Creation Valley Server/Server') 
